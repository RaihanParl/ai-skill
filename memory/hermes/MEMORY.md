User prefers OrbStack over Docker Desktop on this Mac for local container runtimes.
§
User wants Hermes to integrate with OpenCode sessions, including Telegram notifications and possibly approval handling for OpenCode permission prompts; OpenCode-related assistant configs should be pushed to GitHub ai-skill, not GitLab, unless the user explicitly says otherwise.
§
